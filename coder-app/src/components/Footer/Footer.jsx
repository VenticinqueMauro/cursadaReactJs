...
export const Footer = () => {
    return (
        <footer className="d-flex flex-wrap mt-5 justify-content-between align-items-center py-2  border-top text-white footer row">
            <div className="col-md-4 d-flex align-items-center ps-5">
                ...
                <b className="mb-3 mb-md-0 text-muted">Mauro Venticinque</b>
            </div>
