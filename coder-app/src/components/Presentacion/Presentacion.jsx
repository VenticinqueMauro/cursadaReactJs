                ...
                <div className="col-4 container texto">
                    ...
                    <div className="row mt-3">
                        <div className="col-6 text-end animate__animated animate__fadeIn animate__delay-3s">
                            <a href="https://www.linkedin.com/in/mauro-venticinque-39a256235/" target='_blank' className='text-white'><i className="fa-brands fa-linkedin-in iconoPresentacion h4 p-2"></i></a>
                            <a href="https://github.com/VenticinqueMauro" target='_blank' className='text-white'><i className="fa-brands fa-github-alt iconoPresentacion h4 p-2"></i></a>
                            <a href="https://twitter.com/VenticinqueMa" target='_blank' className='text-white'><i className="fa-brands fa-twitter iconoPresentacion h4 p-2"></i></a>
                            <a href="mailto:mauro.venticinque@hotmail.com" className='text-white'><i className="fa-solid fa-envelope iconoPresentacion h4 p-2"></i></a>
                        </div>
